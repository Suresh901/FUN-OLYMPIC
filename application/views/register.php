        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form" action="<?= base_url()?>registration/userregistration">
                        <h2 class="form-title">Create account</h2>
                        <div class="form-group">
                            <input type="text" class="form-input" name="full_name" id="name" placeholder="Your Name" required/>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="user_name" id="name" placeholder="Your User Name" required/>
                        </div>
                        <div class="form-group">
                    ...
                    <p class="loginhere">
                        Have an account ? <a href="<?= base_url()?>/Login" class="loginhere-link">Login here</a>
                    </p>
                </div>
            </div>
        </section>
