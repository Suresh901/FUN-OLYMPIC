                ...
                <tr>
                    ...
                    <td style= "color: #ffcb4d;"><?php echo $row->team2; ?></td>
                      <td> <img src="<?php echo base_url('assets/teamimages/'.$row->logo2)?>" height=100px, width=110px;> </td> 
                        <td> 
                        <a href="<?php echo base_url('schedule/deletelive/'.$row->id); ?>" onclick="return confirm('Are you sure you want to delete this Schedule?');" class="btn btn-success btn-sm delete">Delete</a>
                    </td>
                    <td>
                      <a href="<?= base_url('schedule/viewlive/'.$row->id); ?>"  data-live='<?=$jsondata?>'  type="button" class="btn btn-primary pull-right edit-btn  " style="float:right;"data-toggle="modal" data-target="#exampleModalCenter2" id="edit_<?=$row->id?>">Edit
                      </a>
  ...
  <div class="modal-dialog modal-dialog-centered modal-xl " role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form action="<?= base_url()?>schedule/addlive" method="POST" enctype="multipart/form-data">
  <div class="row">
    <div class="col-6">
      <label>Team 1:</label>
...
<div class="modal fade" id="exampleModalCenter2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-xl " role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form action="<?php echo base_url('schedule/updatelive/'.$row->id); ?>" method="POST" enctype="multipart/form-data">
  <div class="row">
